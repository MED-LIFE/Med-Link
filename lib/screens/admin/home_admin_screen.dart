...
class _HomeAdminScreenState extends State<HomeAdminScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
           // 1. HEADER (PLATINUM: 24px Padding)
           Container(
             padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 8), // 16->24, 6->8
             decoration: const BoxDecoration(
               ...
               boxShadow: [BoxShadow(color: Color(0xFF2376F6), blurRadius: 16, offset: Offset(0, 8), spreadRadius: -5)], // 15->16
             ),
             child: SafeArea(
               bottom: false,
               child: Row(
                 children: [
                   ...
                   IconButton(
                    ...
                    Container(
                       ...
                       child: InkWell(
                         onTap: () => Navigator.pushNamed(context, '/mi_perfil'), // Cap 1: Avatar Navigation
          ...
          Expanded(
            child: FadeTransition(
              ...
              child: SlideTransition(
                ...
                SizedBox(
                  ...
                  child: Stack(
                    ...
                    children: [
                       ...
                       // TEXT CONTENT (PLATINUM: 24/32/48 Padding)
                       Positioned.fill(
                         child: Padding(
                           padding: const EdgeInsets.fromLTRB(32, 48, 24, 16), // 28->32, 45->48
                           child: Column(
                       ...
                       // FLOATING SEARCH BAR (PLATINUM: 24px)
                       Positioned(
                         bottom: 0, 
                         left: 24, // 16->24
                         right: 24, // 16->24
                         height: 48, // 50->48
                         child: ClipRRect(
                           borderRadius: BorderRadius.circular(24), // 25->24
                ...
                // NAV BUTTONS (Moved & Resized to fit "enanos")
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      const SizedBox(width: 12),
                      _buildNavButton(context, Icons.medical_services_rounded, "Staff", () => Navigator.pushNamed(context, '/admin/profesionales')),
                      const SizedBox(width: 12),
                      _buildNavButton(context, Icons.person_add_rounded, "Alta Paciente", () => Navigator.pushNamed(context, '/patient/new')),
                    ],
                  ),
                ),
                ...
                const SizedBox(height: 32), // 24->32
                 ...
                 // LIST
                 Padding(
                   padding: const EdgeInsets.symmetric(horizontal: 26), // 18->26 (aligns with 24 + safe 2)
                   child: Row(
      ...
      child: BouncingCard( // PLATINUM: Bounce
        ...
        child: Container(
             ...
             decoration: BoxDecoration(
               color: Colors.white,
               borderRadius: BorderRadius.circular(16),
               boxShadow: [BoxShadow(color: const Color(0xFF2376F6).withOpacity(0.08), blurRadius: 16, offset: const Offset(0, 4))],
             ),
             child: Column(
               children: [
                 Container(
                   ...
                   child: Icon(icon, color: const Color(0xFF1565C0), size: 20), // Reduced from 24
                 ),
                 const SizedBox(height: 8),
                 Text(label, style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 12, color: Color(0xFF0D1C2E))), // Reduced from 13
               ],
             ),
        ),
      ),
...
class WaveChartPainter extends CustomPainter {
  final Color color;
  WaveChartPainter({required this.color});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    strokePath.moveTo(0, size.height * 0.6);
    strokePath.cubicTo(
      size.width * 0.25, size.height * 0.4, 
      size.width * 0.75, size.height * 0.8, 
      size.width, size.height * 0.2
...
class RadialProgressPainter extends CustomPainter {
  ...
  RadialProgressPainter({required this.color, required this.progress});
